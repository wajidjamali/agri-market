const styles = {
  ...
  price: "font-[500] text-[15px] text-[#d55b45] pl-3 mt-[-4px] line-through",
  shop_name: "pt-3 text-[15px] text-blue-400 pb-1",
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
  button:
    "w-[140px] bg-[#6eb726] h-[40px] my-3 flex items-center justify-center rounded-md cursor-pointer",
  cart_button:
    "px-[20px] h-[38px] rounded-[20px] bg-[orange] flex items-center justify-center cursor-pointer",
